"""
Test DynaPrompt V6 with hybrid detection + boosting
"""
...
def main():
    ...
    parser.add_argument(
        "--outdir",
        type=str,
        default="data/images/dynaprompt_v6_test",
    ...
    parser.add_argument(
        ...
        type=int,
        default=5,
        help="Maximum seed attempts before fallback (default: 5)"
    )
    parser.add_argument(
        "--boost_factor",
        type=float,
        default=2.5,
        help="Attention boost factor for fallback (default: 2.5)"
    )
    parser.add_argument(
        "--critical_tokens",
        type=str,
    ...
    print("="*80)
    print("DynaPrompt V6 Test (Hybrid: Detection + Boosting)")
    print("="*80)
    ...
    print(f"Boost factor (fallback): {args.boost_factor}")
    print("="*80 + "\n")
    ...
    dynaprompt_v6_sampler = DynaPromptV6Sampler(
    ...
    # Sample
    print("\n" + "="*80)
    print("Starting DynaPrompt V6 sampling...")
    print("="*80)

    shape = [4, 64, 64]  # Latent shape for 512x512 image
    batch_size = 1

    samples, intermediates = dynaprompt_v6_sampler.sample_with_dynaprompt(
        prompt=args.prompt,
    ...
    for i, x_sample in enumerate(x_samples):
        ...
        output_path = os.path.join(args.outdir, f"dynaprompt_v6_sample_{i:04d}.png")
    ...
    print("\n" + "="*80)
    print("✓ DynaPrompt V6 test complete!")
